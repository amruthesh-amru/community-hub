...
function JobAndInternship() {
  ...
  const uploadImageToDb = async () => {
    ...
    const imgs = ref(imgDB, `jobandinternship/${v4()}`);
    let uploadResponse;
    ...
    const docRef = doc(db, "jobandinternship", v4());
  ...
  // fetching tweets
  useEffect(() => {
    const collectionRef = collection(db, "jobandinternship");
